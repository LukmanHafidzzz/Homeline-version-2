...
class UserController {
    ...
    async fotoRumah(req, res) {
        const rumah_id = req.params.rumah_id
        const fotoRumah = await db.promise().query(`SELECT foto_rumah.foto_rumah_id, foto_rumah.rumah_id, foto_rumah.foto FROM (foto_rumah JOIN data_rumah USING (rumah_id)) WHERE rumah_id = '${rumah_id}'`)
